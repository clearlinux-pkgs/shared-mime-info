...
Version  : 1.10
Release  : 21
URL      : https://www.freedesktop.org/~hadess/shared-mime-info-1.10.tar.xz
Source0  : https://www.freedesktop.org/~hadess/shared-mime-info-1.10.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722967280
...
cp %{_builddir}/shared-mime-info-%{version}/COPYING %{buildroot}/usr/share/package-licenses/shared-mime-info/4cc77b90af91e615a64ae04893fdffa7939db84c || :
export GOAMD64=v2
GOAMD64=v2
%make_install
