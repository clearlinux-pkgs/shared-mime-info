...
Requires: shared-mime-info-license
Requires: shared-mime-info-locales
Requires: shared-mime-info-man
...
export LANG=C
export SOURCE_DATE_EPOCH=1530492202
...
export SOURCE_DATE_EPOCH=1530492202
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/shared-mime-info
cp COPYING %{buildroot}/usr/share/doc/shared-mime-info/COPYING
%make_install
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/shared-mime-info/COPYING
